  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href={`/instructor/courses/${courseId}/assessments/new`}>
      ...
      {assessments.length === 0 ? (
        <div className="rounded border bg-card p-12 text-center text-muted-foreground">
          ...
          <Button asChild variant="outline">
            <Link href={`/instructor/courses/${courseId}/assessments/new`}>Create one now</Link>
          </Button>
        </div>
      ) : (
              ...
              <div key={a.id} className="rounded-lg border bg-card p-6 shadow-sm flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button asChild variant="outline" size="sm">
                    <Link href={`/instructor/courses/${courseId}/assessments/${a.id}`}>
